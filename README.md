 ...
 * [sdk для устройств под управлением adroid](https://github.com/WapStart/plus1-android-sdk)
...
вы всегда можете написать свою реализацию, используя нижеприведенный API.
 
Наши реализации подключений полностью следуют данному api, вы всегда можете их использовать в качестве примера реализации.
