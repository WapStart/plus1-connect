...
/?area=application&version=2, где version равный 2 символизирует использование соответствующей версии API
...
* *realSiteId* - параметр для партнерских сетей: идентификатор площадки в вашей системе. Беззнаковое целое. Необязательный параметр.
...
/?area=viewBanner&version=2 или /?area=viewBannerXml&version=2, где version равный 2 символизирует использование соответствующей версии API
